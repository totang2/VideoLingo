...
# use sentence_splitbynlp.txt instead of sentence_splitbymeaning.txt, it does not need askgpt
SENTENCE_SPLIT_FILE = "output/log/sentence_splitbynlp.txt"
...
def translate_all():
    ...
    for i in range(len(src_text)):
        trans_text.append(src_text[i].replace(' ', ''))
